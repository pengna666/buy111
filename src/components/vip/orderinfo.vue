                                ...
                                <div class="form-box accept-box form-box1">
                                    <dl class="head form-group">
                                        <dd>
                                            ...
                                            <router-link v-if="orderinfo.status==1" :to="'/pay?orderid='+orderinfo.id">去付款</router-link>
            ...
            getOrderInfo(){
                ...
                this.$axios.get(url).then(response=>{
                    ...
                    response.data.message.goodslist.forEach(item=>{
                        this.goodsAmount += item.real_price * item.quantity
                    })
                    // 商品总价格+运费
                    this.TotalAmount = this.goodsAmount + response.data.message.orderinfo.express_fee
